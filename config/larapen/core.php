...
return [
	...
	/*
	 ...
	 |
	 | debugBar:
	 | In addition of this option, the Debug Bar will be enabled when APP_DEBUG is true
	 |
     */
	'performance' => [
	...
	/*
	 ...
	 | - By setting the option bellow to 'false', and since it's not possible de disable email field
     ...
     */
	'register' => [
		'showCompanyFields' => env('REGISTER_SHOW_COMPANY_FIELDS', false), // Show/Hide Company fields from Registration Form depending on the User Type
		'showResumeFields'  => env('REGISTER_SHOW_RESUME_FIELDS', false), // Show/Hide Resume fields from Registration Form depending on the User Type
	],
	...
	/*
	 ...
	 | - timeout: API timeout when 'curl' is used to consume the API (in seconds)
	 |
     */
	'api' => [
